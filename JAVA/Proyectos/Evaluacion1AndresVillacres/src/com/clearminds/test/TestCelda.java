...
public class TestCelda {
	public static void main(String[] args) {
		...
		//El objeto celda es instanciado, pero el producto que contiene una celda no,
		//por lo que da un error al tratar de obtener el nombre de un producto nunca instanciado.
