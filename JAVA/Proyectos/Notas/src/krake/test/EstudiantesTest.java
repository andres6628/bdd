...
public static void main(String[] args) {
	 ...
	 Nota nuevaNota = new Nota(ciencias,9.0f);
	 Nota nuevaNota2 = new Nota(ciencias, 9.0f);
	 Nota nuevaNota3 = new Nota(matematicas,2.0f);
	 Nota nuevaNota4 = new Nota(matematicas,-8.0f);
